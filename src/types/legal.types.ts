...
export const TRIGGER_EVENT_LABELS: Record<TriggerEvent, string> = {
  ...
  SOLVER_ENROLLMENT: 'Solution Provider Enrollment',
  ...
  SOLVER_SHORTLISTED: 'Solution Provider Shortlisted',
...
export const TRIGGER_EVENT_DESCRIPTIONS: Record<TriggerEvent, string> = {
  ...
  SOLVER_ENROLLMENT: 'When a Solution Provider registers to participate in challenges',
  CHALLENGE_SUBMIT: 'When a challenge is submitted for review',
  CHALLENGE_PUBLISH: 'When a challenge is published to Solution Providers',
  CHALLENGE_JOIN: 'When a Solution Provider joins a published challenge',
  ABSTRACT_SUBMIT: 'When a Solution Provider submits an abstract proposal',
  SOLVER_SHORTLISTED: 'When a Solution Provider is shortlisted for a challenge',
  SOLUTION_SUBMIT: 'When a Solution Provider submits their final solution',
