...
const DIFFICULTY_TARGETS: Record<QuestionDifficulty, { min: number; max: number }> = {
...
const QUESTION_TYPE_TARGETS: Record<string, { min: number; max: number }> = {
...
const MANDATORY_CAPABILITY_CATEGORIES = [
  'strategic thinking',
...
// Max percentage per capability tag
const MAX_CAPABILITY_PERCENTAGE = 0.30;  // 30% = 6 questions max
