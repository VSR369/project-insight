...
export const IP_OPTIONS = [
  {
    ...
    tooltip: 'The Solution Provider transfers all intellectual property rights to you upon acceptance. They may not use, license, or sell the solution to anyone else.',
  },
  {
    value: 'IP-NEL',
    label: 'Non-Exclusive License',
    short: 'Solution Provider keeps IP, you get license',
    tooltip: 'The Solution Provider retains ownership but grants you a perpetual, non-exclusive license to use the solution. The Solution Provider may license it to others.',
  },
  {
    value: 'IP-EL',
    label: 'Exclusive License',
    short: 'Solution Provider keeps IP, exclusive use for you',
    tooltip: 'The Solution Provider retains ownership but grants you an exclusive license. No other party (including the Solution Provider) may use or license the solution.',
  },
  {
    value: 'IP-JO',
