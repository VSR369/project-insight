...
export const AGG_SEED: SeedContent = {
  ...
  weighted_criteria: [
    ...
    { name: 'Organizational Transformation Depth', weight: 20 },
    { name: 'Domain Expertise & Financial Services Knowledge', weight: 15 },
    { name: 'Implementation Approach & Risk Mitigation', weight: 15 },
  ],
  deliverables_list: [],
  ip_model: 'IP-EL',
  expected_outcomes: [
