...
// Lifecycle rank to progress percentage mapping
...
export function EnrollmentSwitcher({ variant = 'header' }: EnrollmentSwitcherProps) {
  ...
  const getProgress = (status: string) => LIFECYCLE_PROGRESS_MAP[status] || 0;
  ...
  const getStatusBadgeVariant = (status: string): 'default' | 'secondary' | 'destructive' => {
    ...
    if (status === 'not_verified') return 'destructive';
    return 'secondary';
  };
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent align="start" className="w-80 bg-popover">
        ...
        <div className="max-h-[300px] overflow-y-auto">
          {enrollments.map((enrollment) => {
            const progress = getProgress(enrollment.lifecycle_status);
            ...
            return (
              ...
              >
                <div className="flex items-center gap-2 w-full">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      <Badge 
                        variant={getStatusBadgeVariant(enrollment.lifecycle_status)}
                ...
                {/* Progress bar for non-terminal enrollments */}
                {!terminal && (
