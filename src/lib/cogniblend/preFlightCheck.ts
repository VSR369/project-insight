...
export const SECTION_TO_TAB: Record<string, string> = {
  ...
  solver_expertise: 'Solution Providers & Schedule',
  eligibility: 'Solution Providers & Schedule',
  phase_schedule: 'Solution Providers & Schedule',
  submission_guidelines: 'Solution Providers & Schedule',
