...
export function useProviderSelectedTaxonomy(enrollmentId?: string) {
  return useQuery({
    ...
    queryFn: async (): Promise<ProficiencyArea[]> => {
      ...
      // Step 2: Fetch the proficiency areas with their details
      ...
      // Step 3: Fetch all sub_domains for selected areas
      ...
      // Step 4: Fetch all specialities for these sub_domains
