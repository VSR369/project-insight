...
export function useCurationPageOrchestrator() {
  ...
  // ── Effects ──
  useCurationEffects({ challenge: challenge as Record<string, unknown> | null, aiReviewsLoaded, setAiReviews, setAiReviewsLoaded, setPass1DoneSession, saveSectionMutation });
