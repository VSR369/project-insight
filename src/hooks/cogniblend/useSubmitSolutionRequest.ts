...
/**
 * Shared helper: builds the extended_brief object and full challenge update payload
 * used by both useSaveDraft and useUpdateDraft.
 */
function buildChallengeUpdatePayload(
  fp: DraftPayload,
