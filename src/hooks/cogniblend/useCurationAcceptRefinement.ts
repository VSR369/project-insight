...
function normalizeRewardStructure(
  ...
  return null; // signal: handled by ref
}

function normalizeEvalCriteria(dbField: string, value: any): any {
...
function normalizeSuccessMetrics(dbField: string, value: any): any {
...
function normalizeDataResources(dbField: string, value: any): any {
...
function normalizeDomainTags(dbField: string, value: any): any | null {
