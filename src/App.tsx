...
// Legal v3: WorkforcePwaGate removed — role agreements are signed once at
// first login via RoleLegalGate (mounted in AuthGuard). Per-route gating is
// no longer required.
...
const CreatorChallengeReviewPage = lazy(() => import("@/pages/cogniblend/CreatorChallengeReviewPage"));
...
const QuickReviewPage = lazy(() => import("@/pages/cogniblend/QuickReviewPage"));
...
const QualityTelemetryPage = lazy(() => import("@/pages/admin/QualityTelemetryPage"));
        ...
        <AuthProvider>
          ...
          <Routes>
            ...
            <Route path="/admin" element={
              ...
              <Route path="ai-quality/telemetry" element={<PermissionGuard permissionKey="supervisor.configure_system"><QualityTelemetryPage /></PermissionGuard>} />
