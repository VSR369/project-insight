...
import {
  ...
  useRestoreOrganizationType,
  OrganizationType,
  OrganizationTypeInsert,
} from "@/hooks/queries/useOrganizationTypes";
...
const formFields: FormFieldConfig<OrganizationTypeFormData>[] = [
  {
    ...
    label: "Type Code",
    type: "text",
    placeholder: "e.g., CORP, SME, STARTUP",
    description: "Unique identifier code for this organization type",
    required: true,
  },
  {
    name: "name",
    label: "Type Name",
    type: "text",
    placeholder: "e.g., Corporation, Small Business, Startup",
    required: true,
  },
  {
    name: "description",
  ...
  },
  {
    ...
    label: "Active",
    type: "switch",
    description: "Inactive types are hidden from users",
  },
];
...
export default function OrganizationTypesPage() {
  ...
  const handleSubmit = async (data: OrganizationTypeFormData) => {
    if (selectedType) {
      ...
      await createMutation.mutateAsync(data as OrganizationTypeInsert);
    }
  };
  ...
  return (
    <AdminLayout
      ...
      description="Manage organization categories for solution providers"
      breadcrumbs={[
    ...
    >
      <DataTable
        ...
        isLoading={isLoading}
        onAdd={handleAdd}
        addButtonLabel="Add Organization Type"
        emptyMessage="No organization types found. Add your first organization type to get started."
      />
      ...
      <MasterDataForm
        ...
        description="Organization types categorize the entities that providers represent."
        fields={formFields}
