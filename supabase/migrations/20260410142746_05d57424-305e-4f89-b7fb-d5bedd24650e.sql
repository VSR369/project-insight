...
-- ============================================================
-- Fix 1: complete_phase — sla_hours → sla_days
-- ============================================================
...
BEGIN
  ...
  -- Start SLA timer for next phase (FIXED: use sla_days instead of sla_hours)
...
-- ============================================================
-- Fix 2: Restore initialize_challenge with full logic + CR role
-- ============================================================
...
BEGIN
  ...
  EXCEPTION WHEN undefined_function THEN
    NULL; -- skip if function not deployed
  END;
  ...
  EXCEPTION WHEN undefined_function THEN
    -- Fallback: at minimum assign CR role
