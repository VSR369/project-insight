-- Make pool_member_id nullable for direct org assignments
ALTER TABLE public.challenge_role_assignments
  ALTER COLUMN pool_member_id DROP NOT NULL;

-- Recreate assign_challenge_role to guard workload increment
