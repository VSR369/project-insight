...
-- Add SLA_STARTED audit entries to complete_phase when advancing phases
-- Also ensure LIFECYCLE_COMPLETED maps to CHALLENGE_COMPLETED audit action
...
BEGIN
  ...
  INSERT INTO public.audit_trail (
    ...
    p_challenge_id, p_user_id, 'SLA_STARTED', 'SYSTEM',
    jsonb_build_object(
      'phase', v_next_phase,
      'role_code', v_next_required_role,
      'deadline_interval', '5 days'
    )
  );
