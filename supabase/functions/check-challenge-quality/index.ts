...
Analyze a challenge specification and provide a structured quality assessment using the assess_challenge_quality tool.
...
serve(async (req) => {
  ...
  try {
    ...
    // Fetch challenge data using service role for full access
    ...
    const userPrompt = `Analyze this challenge specification for quality and solver readiness:
              ...
              parameters: {
                ...
                properties: {
                  ...
                  gaps: {
                    ...
                    description: "List of identified gaps or issues",
                  },
                ...
                required: ["overall_score", "completeness_score", "clarity_score", "solver_readiness_score", "summary", "gaps", "flagged_checklist_items", "strengths"],
