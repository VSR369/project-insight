...
export const SECTION_WAVE_CONTEXT: Record<string, {
  ...
  domain_tags: {
    ...
    downstreamSections: ['solver_expertise'],
  },
  complexity: {
    wave: 6, waveName: 'Assessment',
  ...
  solver_expertise: {
    ...
    upstreamSections: ['deliverables', 'complexity', 'solution_type', 'domain_tags'],
    downstreamSections: ['eligibility'],
  },
  eligibility: {
    wave: 7, waveName: 'Execution',
  ...
  reward_structure: {
    ...
    upstreamSections: ['complexity', 'maturity_level', 'deliverables', 'phase_schedule', 'solver_expertise'],
    downstreamSections: [],
  },
  ip_model: {
    wave: 9, waveName: 'Presentation',
