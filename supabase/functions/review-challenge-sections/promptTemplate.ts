...
const EXTENDED_BRIEF_FORMAT_INSTRUCTIONS: Record<string, string> = {
  ...
  reward_structure: 'Output: JSON object: { "type": "monetary"|"non_monetary"|"both", "monetary": { "tiers": { "platinum": 75000, "gold": 25000, "silver": 10000 }, "currency": "USD" }, "nonMonetary": { "items": ["Recognition on platform", "Access to seeker network"] } }. CRITICAL: tiers must be an OBJECT mapping tier name to amount (e.g. {"platinum": 75000}), NOT an array. Valid tier keys: platinum, gold, silver. Amounts must be plain numbers, not strings.',
